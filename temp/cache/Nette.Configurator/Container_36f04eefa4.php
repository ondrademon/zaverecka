<?php
// source: F:\xampp\htdocs\sandbox\app/config/config.neon 
// source: F:\xampp\htdocs\sandbox\app/config/config.local.neon 

class Container_36f04eefa4 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\ArticlePresenter' => [1 => ['application.4']],
		...
		'services' => [
			...
			'application.4' => 'App\Presenters\ArticlePresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'F:\xampp\htdocs\sandbox\app',
			'wwwDir' => 'F:\xampp\htdocs\sandbox\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'F:\xampp\htdocs\sandbox\app/../temp',
		];
	}
	...
	public function createServiceApplication__4(): App\Presenters\ArticlePresenter
	{
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'F:\xampp\htdocs\sandbox\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('F:\xampp\htdocs\sandbox\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('F:\xampp\htdocs\sandbox\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=test1', 'root',
			null, null);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_36f04eefa4 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('F:\xampp\htdocs\sandbox\app/../temp/cache/latte');
